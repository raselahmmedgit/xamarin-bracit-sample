...
namespace hBuddyApp.Droid.Features.PushNotifications
{
    public class PushNotificationPermissionInitializer : hBuddyApp.Features.PushNotifications.IPushNotificationInitializer
    {
