...
using Android.App;
using Android.Views;
using hBuddyApp.Effects;
using Xamarin.Forms;
using Xamarin.Forms.Platform.Android;

[assembly: ExportEffect(typeof(hBuddyApp.Droid.Effects.SafeAreaPaddingEffect), hBuddyApp.Effects.SafeAreaPaddingInsetEffect.EffectName)]
