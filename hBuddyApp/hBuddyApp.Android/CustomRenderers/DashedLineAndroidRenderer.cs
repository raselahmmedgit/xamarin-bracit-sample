...
using hBuddyApp.Droid.CustomRenderers;
using hBuddyApp.PlatformSpecific;
using Xamarin.Forms;
using Xamarin.Forms.Platform.Android;

[assembly: ExportRenderer(typeof(DashedLine), typeof(DashedLineAndroidRenderer))]

namespace hBuddyApp.Droid.CustomRenderers
{
    public class DashedLineAndroidRenderer : ViewRenderer
    {
        ...
        protected override void OnDraw(Canvas canvas)
        {
            ...
            _paint.Color = Xamarin.Forms.Color.FromRgba(color.R, color.G, color.B, dashedLine.Alpha).ToAndroid();

            _effects = new DashPathEffect(new float[] { 2, 10 }, 0);
