...
using hBuddyApp.Droid.CustomRenderers.HybridWebView;
using hBuddyApp.Features.Controls.HybridWebView;
using Xamarin.Forms;
using Xamarin.Forms.Platform.Android;

[assembly: ExportRenderer(typeof(HybridWebView), typeof(HybridWebViewRenderer))]
namespace hBuddyApp.Droid.CustomRenderers.HybridWebView
{
    public class HybridWebViewRenderer : WebViewRenderer
    {
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                ...
                ((hBuddyApp.Features.Controls.HybridWebView.HybridWebView)Element).Cleanup();
            }
