...
using hBuddyApp.Features.CreateProfile.Validation;
using hBuddyApp.Features.Exceptions;
...
namespace hBuddyApp.Features.CreateProfile
{
    public class CreateProfileViewModel : ViewModelBase
    {
        ...
        private void ValidateUsername()
        {
            if (string.IsNullOrWhiteSpace(UsernameValue))
            {
                ...
                UsernameErrorText = hBuddyApp.Features.CreateProfile.Resources.Localization.CreateProfile_Requirement_Filled_Username_Text;
            }
            else
            {
                ...
                {
                    UsernameHasAnError = true;
                    UsernameErrorText = hBuddyApp.Features.CreateProfile.Resources.Localization
        ...
        private void ValidateConfirmPassword()
        {
            ...
            ErrorText = isValid ? string.Empty : hBuddyApp.Features.CreateProfile.Resources.Localization.CreateProfile_Requirement_Same_Passwords_Text;
