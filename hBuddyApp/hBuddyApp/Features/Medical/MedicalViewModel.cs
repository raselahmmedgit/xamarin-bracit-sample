...
using hBuddyApp.Features.Account.Models;
using hBuddyApp.Features.Account.Services;
using Prism.Navigation;
using System.Linq;
using hBuddyApp.Features.MedicalChangeStatus;
using hBuddyApp.Features.MedicalLogin.Components.LogIn;
...
namespace hBuddyApp.Features.Medical
{
    public class MedicalViewModel : CompositeViewModelBase
    {
        ...
        public MedicalViewModel(INavigationService navigationService, IAccountInformationContainer accountContainer, MedicalChangeStatus.MedicalChangeStatusViewModel medicalChangeStatusViewModel, MedicalLoginViewModel medicalLoginViewModel)
            : base(navigationService)
        {
            ...
            AttachToHost(MedicalChangeStatusViewModel, nameof(MedicalChangeStatusViewModel));
            AttachToHost(MedicalLoginViewModel, nameof(MedicalLoginViewModel));
        }
