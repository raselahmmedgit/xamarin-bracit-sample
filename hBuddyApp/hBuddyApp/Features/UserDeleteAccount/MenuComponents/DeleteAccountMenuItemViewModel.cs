...
namespace hBuddyApp.Features.UserDeleteAccount.MenuComponents
{
    public class DeleteAccountMenuItemViewModel : MenuItemViewModel
    {
        private const string DeleteAccountIconSource = "resource://hBuddyApp.Features.UserDeleteAccount.Resources.Images.delete.svg";
