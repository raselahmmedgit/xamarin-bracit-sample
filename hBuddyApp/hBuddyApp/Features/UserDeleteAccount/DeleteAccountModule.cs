...
using hBuddyApp.Features.UserDeleteAccount.MenuComponents;
using hBuddyApp.Features.UserDeleteAccount.Routes;
using hBuddyApp.Features.UserDeleteAccount.Services;
using Prism.Ioc;
using Prism.Modularity;

namespace hBuddyApp.Features.UserDeleteAccount
{
