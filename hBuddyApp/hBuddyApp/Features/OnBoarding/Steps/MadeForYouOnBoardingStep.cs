...
namespace hBuddyApp.Features.OnBoarding.Steps
{
    public class MadeForYouOnBoardingStep : OnBoardingStepBase, IOnBoardingStep
    {
        private const string TailoredForYouImage = "resource://hBuddyApp.Features.OnBoarding.Resources.Images.tailored_for_you.svg";
