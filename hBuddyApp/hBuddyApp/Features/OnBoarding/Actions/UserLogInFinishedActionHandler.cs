...
{
    public class UserLogInFinishedActionHandler : AsyncRequestHandler<UserLogInFinishedAction>, IRequestHandler<UserLogInFinishedAction, Unit>
    {
        ...
        public UserLogInFinishedActionHandler(
        ...
        protected override async Task Handle(UserLogInFinishedAction request, CancellationToken cancellationToken)
        {
