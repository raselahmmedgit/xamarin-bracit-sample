...
#nullable enable
namespace hBuddyApp.Features.Regions
{
    public class RegionManager : BindableObject
    {
        ...
        private RegionManager(string regionIdentifier, IList<IComponentService> componentServices, HostContext hostContext)
        {
            ...
            foreach (var service in componentServices)
            {
                ...
                {
                    // Workaround from the error System.ArgumentException: An item with the same key has already been added. Key: hBuddyApp.Features.ComponentsManagement.Internal.ComponentsGroup.
