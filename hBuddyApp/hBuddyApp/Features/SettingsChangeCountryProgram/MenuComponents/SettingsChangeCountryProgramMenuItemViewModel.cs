...
namespace hBuddyApp.Features.SettingsChangeCountryProgram.MenuComponents
{
    ...
    {
        private const string SettingsChangeCountryProgramIconSource = "resource://hBuddyApp.Features.ChangeCountryProgram.Resources.Images.countryprogram_menu.svg";
        private readonly IMediator _mediator;

        public SettingsChangeCountryProgramMenuItemViewModel(IMediator mediator)
        {
            _mediator = mediator;
            Title = hBuddyApp.Features.ChangeCountryProgram.Resources.Localization.Menu_ChangeCountryProgram_ItemText;
