...
using System;
using hBuddyApp.Features.MedicalLogin.Services;
using ReactiveUI;
using System.Reactive;
using System.Threading.Tasks;
using hBuddyApp.Services.ErrorHandlers;

namespace hBuddyApp.Features.MedicalLogin.Components.LogIn
{
    public class MedicalLoginViewModel : ComponentViewModelBase
    {
        ...
        private void ValidateMedicalId(string value)
        {
            if (string.IsNullOrWhiteSpace(value))
            {
                ...
                MedicalIdErrorText = Resources.Localization.MedicalLogIn_MedicalId_EmptyErrorMessage_Text;
            }
            else
            {
