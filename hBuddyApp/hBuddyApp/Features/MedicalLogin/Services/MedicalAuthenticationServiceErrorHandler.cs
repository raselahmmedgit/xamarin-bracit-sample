...
namespace hBuddyApp.Features.MedicalLogin.Services
{
    public class MedicalAuthenticationServiceErrorHandler : ErrorResponseHandler, IMedicalAuthenticationServiceErrorHandler
    {
            ...
            out Exception generatedException)
        {
            foreach (var errorItem in errors)
            {
                ...
                {
                    generatedException = new MedicalAuthenticationException(Resources.Localization.MedicalAuthenticationException_InvalidHealthSecurityId_ErrorText);
                    return true;
                }
            }
