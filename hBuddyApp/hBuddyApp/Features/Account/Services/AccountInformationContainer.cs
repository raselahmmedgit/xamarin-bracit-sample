...
namespace hBuddyApp.Features.Account.Services
{
    public class AccountInformationContainer : IAccountInformationContainer
    {
        ...
        public AccountInformationContainer(IStorageService storageService)
        {
