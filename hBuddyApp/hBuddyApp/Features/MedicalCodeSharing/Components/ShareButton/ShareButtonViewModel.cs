...
namespace hBuddyApp.Features.MedicalCodeSharing.Components.ShareButton
{
    public class ShareButtonViewModel : ComponentViewModelBase
    {
        ...
        private async void ShareCode()
        {
            try
            {
                await Share.RequestAsync(new ShareTextRequest(_code, Resources.Localization.MedicalCodeSharing_ShareSystem_TitleText));
            }
            catch (Exception ex)
            {
