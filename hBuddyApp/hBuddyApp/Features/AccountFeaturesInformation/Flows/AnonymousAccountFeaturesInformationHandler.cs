...
namespace hBuddyApp.Features.AccountFeaturesInformation.Flows
{
    public class AnonymousAccountFeaturesInformationHandler : IAccountFeaturesInformationHandler
    {
        ...
        public AnonymousAccountFeaturesInformationHandler(IMediator mediator, IErrorHandler errorHandler)
        {
            ...
            {
                new InformationItem(Resources.Localization.AnonymProfile_Instruction_Text1, "resource://hBuddyApp.Features.AccountFeaturesInformation.Resources.Images.health_wellbeing.svg"),
                new InformationItem(Resources.Localization.AnonymProfile_Instruction_Text2, "resource://hBuddyApp.Features.AccountFeaturesInformation.Resources.Images.highlight.svg")
            };
        }
