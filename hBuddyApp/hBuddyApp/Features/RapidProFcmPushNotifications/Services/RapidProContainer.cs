...
namespace hBuddyApp.Features.RapidProFcmPushNotifications.Services
{
    public class RapidProContainer
    {
        ...
        private const string RapidProIsDatabaseKey = "RapidProIsDatabase";
        ...
        public bool RapidProIsDatabase
        {
            get
            {
                return Application.Current.Properties.ContainsKey(RapidProIsDatabaseKey) ? Convert.ToBoolean(Application.Current.Properties[RapidProIsDatabaseKey].ToString()) : false;
            }
            set
            {
                if (Application.Current.Properties != null)
                {
                    Application.Current.Properties[RapidProIsDatabaseKey] = value;
                    Application.Current.SavePropertiesAsync();
                }
            }
        }
