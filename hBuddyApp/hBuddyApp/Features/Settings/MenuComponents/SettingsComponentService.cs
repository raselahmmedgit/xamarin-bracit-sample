...
namespace hBuddyApp.Features.Settings.MenuComponents
{
    public class SettingsComponentService : StatelessComponentServiceBase
    {
        ...
        public SettingsComponentService(
        ...
        public override string ComponentKey { get => nameof(SettingsComponentService); }
        ...
        private async Task<IList<Type>> GetComponentTypesByProfileAsync()
        {
            ...
            //{
            //    return new List<Type>() { typeof(SettingsMenuItemViewModel) };
            //}
            //else
            //{
