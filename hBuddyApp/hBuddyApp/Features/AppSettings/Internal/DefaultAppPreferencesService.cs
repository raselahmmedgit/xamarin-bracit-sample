...
namespace hBuddyApp.Features.AppSettings.Internal
{
    /// <summary>
    ...
    public class DefaultAppPreferencesService : IAppPreferencesService
    {
        ...
        {
            _logger = hBuddyApp.Logs.Logger.Get(this);
        }
        ...
        public string GetValue(string key)
        {
            ...
            {
                _logger.LogErrorExceptCancellation(ex, $"Failed to get value of the app preference {key} from preferences.");
            }
        ...
        public void SetValue(string key, string value)
        {
            ...
            {
                _logger.LogErrorExceptCancellation(ex, $"Failed to set value of the app preference {key} to preferences.");
            }
        }
        ...
        public bool IsAppNeedsForceRefreshUserStatus
        {
            ...
            set
            {
                ...
                {
                    _logger.LogErrorExceptCancellation(ex, $"Failed to send update deeplink.");
                }
            }
        }
    }
