...
using hBuddyApp.Features.UserProfile.Components.BluetoothReminder;
using hBuddyApp.Features.UserProfile.Components.ChangeStatus;
using hBuddyApp.Features.UserProfile.Components.EncryptionStatus;
...
namespace hBuddyApp.Features.UserProfile
{
