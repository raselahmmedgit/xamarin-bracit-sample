...
namespace hBuddyApp.Features.Components
{
    public partial class hBuddyAppEntry : ContentView
    {
        ...
        {
            if (bindable is hBuddyAppEntry label)
            {
        ...
        private void UpdateUnderlineColor(bool? hasError)
        {
            ...
            {
                EntryFrame.BorderColor = PlaceholderNormalColor;
                Entry.PlaceholderColor = PlaceholderNormalColor;
            }
            else
            {
                EntryFrame.BorderColor = hasError.Value ? PlaceholderErrorColor : PlaceholderCorrectColor;
                Entry.PlaceholderColor = hasError.Value ? PlaceholderErrorColor : PlaceholderCorrectColor;
            }
        }
        ...
        {
            if (bindable is hBuddyAppEntry entry)
            {
        ...
        public static readonly BindableProperty PlaceholderErrorColorProperty = BindableProperty.Create(
            nameof(PlaceholderErrorColor),
            typeof(Color),
            typeof(hBuddyAppEntry), Color.Red);

        public Color PlaceholderNormalColor
        {
            get => (Color)GetValue(PlaceholderNormalColorProperty);
            set => SetValue(PlaceholderNormalColorProperty, value);
        }

        public static readonly BindableProperty PlaceholderNormalColorProperty = BindableProperty.Create(
            nameof(PlaceholderNormalColor),
            typeof(Color),
            typeof(hBuddyAppEntry), Color.Red);

        public Color PlaceholderCorrectColor
        {
            get => (Color)GetValue(PlaceholderCorrectColorProperty);
            set => SetValue(PlaceholderCorrectColorProperty, value);
        }

        public static readonly BindableProperty PlaceholderCorrectColorProperty = BindableProperty.Create(
            nameof(PlaceholderCorrectColor),
            typeof(Color),
            typeof(hBuddyAppEntry), Color.Red);
        ...
        public static readonly BindableProperty ReturnTypeProperty = BindableProperty.Create(
            nameof(ReturnType),
            typeof(ReturnType),
            typeof(hBuddyAppEntry), ReturnType.Default);
