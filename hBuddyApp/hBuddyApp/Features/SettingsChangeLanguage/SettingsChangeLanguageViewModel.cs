...
using hBuddyApp.Features.ChangeLanguage.Components;
...
namespace hBuddyApp.Features.SettingsChangeLanguage
{
        ...
        private async Task HandleChangeLanguageAsync(CultureInfo selectedCulture)
        {
            if (selectedCulture != null)
            {
                ...
                var result = await _notificationManager.ShowNotificationAsync(
                    string.Empty,
                    hBuddyApp.Features.ChangeLanguage.Resources.Localization.ChangeLanguage_AlertDescription_Text,
