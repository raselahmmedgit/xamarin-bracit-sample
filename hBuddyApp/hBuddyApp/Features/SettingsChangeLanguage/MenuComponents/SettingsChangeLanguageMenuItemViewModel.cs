...
namespace hBuddyApp.Features.SettingsChangeLanguage.MenuComponents
{
    ...
    {
        private const string SettingsChangeLanguageIconSource = "resource://hBuddyApp.Features.ChangeLanguage.Resources.Images.globe.svg";
        private readonly IMediator _mediator;

        public SettingsChangeLanguageMenuItemViewModel(IMediator mediator)
        {
            _mediator = mediator;
            Title = hBuddyApp.Features.ChangeLanguage.Resources.Localization.Menu_ChangeLanguage_ItemText;
