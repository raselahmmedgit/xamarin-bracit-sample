...
namespace hBuddyApp.Features.SettingsChangeLanguage.MenuComponents
{
    public class SettingsChangeLanguageComponentService : StatelessComponentServiceBase
    {
        ...
        public SettingsChangeLanguageComponentService(
        ...
        public override string ComponentKey { get => nameof(SettingsChangeLanguageComponentService); }
        ...
        private async Task<IList<Type>> GetComponentTypesByProfileAsync()
        {
            ...
            //{
            //    return new List<Type>() { typeof(SettingsChangeLanguageMenuItemViewModel) };
            //}
            //else
            //{
