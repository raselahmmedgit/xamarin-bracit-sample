...
using System;
using hBuddyApp.Services.Security.SecretsProvider.Internal;
using hBuddyApp.Services.Security.SecureVault;

namespace hBuddyApp.Services.Security.SecretsProvider
{
    /// <summary>
    ...
    public static class SecretsProvider
    {
        private static readonly Lazy<ISecretsProvider> DefaultInstance =
            new Lazy<ISecretsProvider>(() => new DefaultSecretsProvider(SecureVaultProvider.Instance));
        ...
        /// </summary>
        public static ISecretsProvider Instance => (_instanceProvider ?? DefaultInstanceProvider).Invoke();
