...
using hBuddyApp.Features.PushNotifications.Models;
using hBuddyApp.iOS.Features.PushNotifications;
...
using hBuddyApp.iOS.Configuration;
using hBuddyApp.Features;
using hBuddyApp.iOS.Services;
using hBuddyApp.Services;
using Prism.Modularity;
using Sharpnado.MaterialFrame.iOS;
using hBuddyApp.iOS.Utils;
using hBuddyApp.iOS.Features.Analytics;
using hBuddyApp.Features.FirebaseRemoteConfig;

namespace hBuddyApp.iOS
{
    ...
    public partial class AppDelegate : global::Xamarin.Forms.Platform.iOS.FormsApplicationDelegate
    {
        ...
        private void SetupAppCenterAndLogger()
        {
            if (!string.IsNullOrWhiteSpace(Constants.AppCenterConstants.Secret_iOS))
            {
                ...
                hBuddyApp.Logs.Logger.Factory.AddProvider(new hBuddyApp.iOS.Services.Log.AppCenterLogProvider(LogLevel.Warning));
            }
        }
