...
using hBuddyApp.iOS.CustomRenderers;
using UIKit;
using Xamarin.Forms;
using Xamarin.Forms.Platform.iOS;

[assembly: ExportRenderer(typeof(hBuddyApp.Features.Controls.OverlayPage), typeof(OverlayPageRenderer))]
namespace hBuddyApp.iOS.CustomRenderers
{
